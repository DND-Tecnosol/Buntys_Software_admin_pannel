...
function Index() {
  ...
  const submit = () => {
    ...
    appAxios.post(apiRoutes.CreateWish,data).then((e)=>{
      console.log(e);
    })
        ...
        <Grid container>
          <Grid item sm={6} xs={12} md={6} height="100%" p={{ xs: 0, sm: 2.5, md: 2.5, xl: 2.5 }} py={{ xs: 2.5 }} >
            <Grid container spacing={3}>
              <Grid item sm={12} xs={12} md={12} height="100%">
                <TextField value={name} onChange={e => setName(e.target.value)} label="Wish Title" sx={{ width: { xs: '100%', sm: '50%', md: '50%', xl: '50%' } }} size="small" />
              </Grid>
              <Grid item sm={12} xs={12} md={12} height="100%">
                <InputLabel id="demo-simple-select-label">Wish Benifits type</InputLabel>
          ...
          <Grid item sm={6} xs={12} md={6} height="100%" p={{ xs: 0, sm: 2.5, md: 2.5, xl: 2.5 }} py={{ xs: 2.5 }} >
            <Grid item sm={12} xs={12} md={12} >
              <InputLabel id="demo-simple-select-label">Wish Type</InputLabel>
              <FormControl fullWidth>
                <Select
                  labelId="demo-simple-select-label"
                  id="demo-simple-select"
              ...
              <InputLabel sx={{marginTop:4}} id="demo-simple-select-label">Wish Target Audiance</InputLabel>
              <FormControl fullWidth >
                <Select
                  labelId="demo-simple-select-label"
                  id="demo-simple-select"
              ...
              {(targetAudiance == "SelectByservice") && <ResorceComponent label="Select service" sx={{marginTop:2}} resouce={products} setResouce={setproducts} resouceData={service} />}
            ...
            <Grid item sm={12} xs={12} md={12} mt={4}>
              <InputLabel id="demo-simple-select-label">Wish Offers Applicable on</InputLabel>
              <FormControl fullWidth>
                <Select
                  labelId="demo-simple-select-label"
                  id="demo-simple-select"
                ...
                >
                  ...
                  <MenuItem value={"weg"}>weg Categury</MenuItem>
...
const ResorceComponent = ({ resouce, setResouce, resouceData, label ,...style}) => {
...
const SelectByCostumerCategury = ({ cateid, setcateid, menu }) => {
  ...
  return (
    <>
      <Grid item sm={12} xs={12} md={12} mt={4}>
        <InputLabel id="demo-simple-select-label">Select Costomer Categury</InputLabel>
        <FormControl fullWidth>
          <Select
...
const NewCustomer = ({ count, setCount, startDate, setStartDate, endDate, setEndDate, label }) => {
  return (
    <>
      <Grid container spacing={[{ xs: 0 }, 4]} sm={12} xs={12} md={12} mt={2} pt={2} height="100%">
        <Grid item sm={6} xs={12} md={6} >
          <InputLabel>Start Date</InputLabel>
          <TextField value={startDate} onChange={(e) => setStartDate(e.target.value)} type={"date"} fullWidth size="small" />
        </Grid>
...
const SelectByViseteddaterange = ({ count, setCount, startDate, setStartDate, endDate, setEndDate, label }) => {
  return (
    <>
      <Grid container spacing={[{ xs: 0 }, 4]} sm={12} xs={12} md={12} height="100%" pt={2}>
        <Grid item sm={6} xs={12} md={6}>
          <InputLabel>Start Date</InputLabel>
          <TextField value={startDate} onChange={(e) => setStartDate(e.target.value)} type={"date"} fullWidth size="small" />
        </Grid>
